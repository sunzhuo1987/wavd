...
public class MyHTMLEditorKit extends javax.swing.text.html.HTMLEditorKit {
     ...
     * 
     */
    private static final long serialVersionUID = -3931413260556505946L;
    ...
    private static class MyHTMLFactory extends HTMLEditorKit.HTMLFactory {
         ...
         * 
         * @see
         * javax.swing.text.html.HTMLEditorKit.HTMLFactory#create(javax.swing
         * .text.Element)
         */
        public View create(Element elem) {
            ...
            if (o instanceof HTML.Tag) {
                ...
                if (kind == HTML.Tag.FRAME || kind == HTML.Tag.FRAMESET || kind == HTML.Tag.OBJECT
                        || kind == HTML.Tag.MAP || kind == HTML.Tag.IMG || kind == HTML.Tag.LINK
                        || kind == HTML.Tag.SCRIPT || kind == HTML.Tag.APPLET) {
