...
public class Proxy implements Plugin {
    ...
    private Proxy.ConnectionHook _allowConnection = new ConnectionHook("Allow connection",
    ...
    private Proxy.ConnectionHook _interceptRequest = new ConnectionHook("Intercept request",
    ...
    private Proxy.ConnectionHook _interceptResponse = new ConnectionHook("Intercept response",
            "Called when the request has been submitted to the server, and the response " + "has been recieved.\n"
    ...
    public void addListener(String address, int port, HttpUrl base, String simulator, boolean primary)
            throws IOException {
    ...
    private void createSimulators() {
        ...
        _simulators.put("DSL (384k down, 128k up)", new NetworkSimulator("DSL (384k down, 128k up)", 10,
                128 * 1024 / 10, 384 * 1024 / 10));
    ...
    private void createListeners() {
        ...
        for (int i = 0; i < listeners.length; i++) {
            ...
            try {
                createListener(addr, port, base, simulator, primary);
     ...
     *             Signals that an I/O exception has occurred.
     */
    private Listener createListener(String address, int port, HttpUrl base, String simulator, boolean primaryProxy)
            throws IOException {
