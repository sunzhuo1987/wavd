...
import edu.lnmiit.wavd.plugin.fuzz.Signature;
...
public class FuzzerPanel extends javax.swing.JPanel implements SwingPluginUI {
    ...
    private class Listener implements PropertyChangeListener, FuzzerListener {
        ...
        /* (non-Javadoc)
         * @see edu.lnmiit.wavd.plugin.fuzz.FuzzerListener#fuzzHeaderAdded(edu.lnmiit.wavd.plugin.fuzz.FuzzerEvent)
         */
        ...
        /* (non-Javadoc)
         * @see edu.lnmiit.wavd.plugin.fuzz.FuzzerListener#fuzzHeaderChanged(edu.lnmiit.wavd.plugin.fuzz.FuzzerEvent)
         */
        ...
        /* (non-Javadoc)
         * @see edu.lnmiit.wavd.plugin.fuzz.FuzzerListener#fuzzHeaderRemoved(edu.lnmiit.wavd.plugin.fuzz.FuzzerEvent)
         */
        ...
        /* (non-Javadoc)
         * @see edu.lnmiit.wavd.plugin.fuzz.FuzzerListener#fuzzParameterAdded(edu.lnmiit.wavd.plugin.fuzz.FuzzerEvent)
         */
        ...
        /* (non-Javadoc)
         * @see edu.lnmiit.wavd.plugin.fuzz.FuzzerListener#fuzzParameterChanged(edu.lnmiit.wavd.plugin.fuzz.FuzzerEvent)
         */
        ...
        /* (non-Javadoc)
         * @see edu.lnmiit.wavd.plugin.fuzz.FuzzerListener#fuzzParameterRemoved(edu.lnmiit.wavd.plugin.fuzz.FuzzerEvent)
         */
