...
public class FuzzerModel extends AbstractPluginModel {
     ...
     * 
     * @param method the new fuzz method
     */
     ...
     * 
     * @param version the new fuzz version
     */
     ...
     * 
     * @param busy the new busy fuzzing
     */
     ...
     * @param fuzzSource the fuzz source
     ...
     * 
     * @param count the new total requests
     */
