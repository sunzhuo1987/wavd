...
public class TranscoderFrame extends javax.swing.JFrame implements ClipboardOwner {
    ...
    /**
     * The listener interface for receiving myUndoableEdit events.
     * The class that is interested in processing a myUndoableEdit
     * event implements this interface, and the object created
     * with that class is registered with a component using the
     * component's <code>addMyUndoableEditListener<code> method. When
