...
public class HTMLPanel extends JPanel implements ByteArrayEditor {
     ...
     * 
     */
    private static final long serialVersionUID = -3551561393613995684L;
    ...
    public void setBytes(String contentType, byte[] bytes) {
        ...
        if (bytes != null) {
            ...
            // FIXME: may need to reset style sheets, etc here. Not sure how to
            // do that, though
	 ...
	 * 
	 */
        private static final long serialVersionUID = -2084874404105438832L;
    ...
    /**
     * The listener interface for receiving linkToolTip events. The class that
     * is interested in processing a linkToolTip event implements this
     * interface, and the object created with that class is registered with a
     * component using the component's
     * <code>addLinkToolTipListener<code> method. When
