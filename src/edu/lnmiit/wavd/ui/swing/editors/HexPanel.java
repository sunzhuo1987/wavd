...
public class HexPanel extends javax.swing.JPanel implements ByteArrayEditor {
     ...
     * 
     */
    private static final long serialVersionUID = 7096807244102913118L;
    ...
    public HexPanel() {
	     ...
	     * 
	     */
            private static final long serialVersionUID = 413084387584779882L;
            ...
            public void actionPerformed(ActionEvent evt) {
                ...
                if (returnVal == JFileChooser.APPROVE_OPTION) {
                    try {
                        ...
                        JOptionPane.showMessageDialog(HexPanel.this, "Error writing file: " + ioe.getMessage(),
	     ...
	     * 
	     */
            private static final long serialVersionUID = -8221928786332068911L;
    ...
    public void setEditable(boolean editable) {
        ...
        // we could do things like make insert and delete buttons visible and
        // invisible here
    }
    ...
    private void initComponents() {
        ...
        hexTable.setModel(new javax.swing.table.DefaultTableModel(new Object[][] {
    ...
    public static void main(String[] args) {
        ...
        try {
            hp.setBytes(null, new byte[] { 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x28, 0x29, 0x2a, 0x2b,
	 ...
	 * 
	 */
        private static final long serialVersionUID = -6489596905472515384L;
        /** The _columns. */
