...
public class MiscPanel extends javax.swing.JPanel implements ProxyPluginUI {
     ...
     * 
     */
    private static final long serialVersionUID = 3016232583254444257L;
    ...
    private void initComponents() {
        ...
        interceptHiddenFieldCheckBox
                .setToolTipText("Select this to change all hidden form fields to text fields. Looks at pages of type HTML and javascript.");
     ...
     *            the evt
     */
    private void readResponseCookiesCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {// GEN
                                                                                             // -
                                                                                             // FIRST
                                                                                             // :
        // event_readResponseCookiesCheckBoxActionPerformed
     ...
     *            the evt
     */
    private void injectRequestCookiesCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {// GEN
                                                                                              // -
                                                                                              // FIRST
                                                                                              // :
        // event_injectRequestCookiesCheckBoxActionPerformed
     ...
     *            the evt
     */
    private void browserCacheCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {// GEN
                                                                                      // -
                                                                                      // FIRST
                                                                                      // :
        // event_browserCacheCheckBoxActionPerformed
     ...
     *            the evt
     */
    private void interceptHiddenFieldCheckBoxActionPerformed(java.awt.event.ActionEvent evt) {// GEN
                                                                                              // -
                                                                                              // FIRST
                                                                                              // :
        // event_interceptHiddenFieldCheckBoxActionPerformed
