...
public class ManualEditPanel extends javax.swing.JPanel implements ProxyPluginUI, ManualEditUI {
     ...
     * 
     */
    private static final long serialVersionUID = -8172551986082333139L;
    ...
    private void initComponents() {// GEN-BEGIN:initComponents
        ...
        interceptIncludeRegexTextField
                .setToolTipText("Use a regular expression to select which URLs to intercept. Leave blank to ignore.");
        ...
        interceptExcludeRegexTextField
                .setToolTipText("Use a regular expression to select which URLs not to intercept. Leave blank to ignore.");
	     ...
	     * 
	     */
            private static final long serialVersionUID = 4297356000669210627L;
     ...
     *            the evt
     */
    private void interceptExcludeRegexTextFieldFocusLost(java.awt.event.FocusEvent evt) {// GEN
                                                                                         // -
                                                                                         // FIRST
                                                                                         // :
        // event_interceptExcludeRegexTextFieldFocusLost
     ...
     *            the evt
     */
    private void interceptExcludeRegexTextFieldActionPerformed(java.awt.event.ActionEvent evt) {// GEN
                                                                                                // -
                                                                                                // FIRST
                                                                                                // :
        // event_interceptExcludeRegexTextFieldActionPerformed
        _manualEdit.setExcludeRegex(interceptExcludeRegexTextField.getText());
     ...
     *            the evt
     */
    private void interceptIncludeRegexTextFieldActionPerformed(java.awt.event.ActionEvent evt) {// GEN
                                                                                                // -
                                                                                                // FIRST
                                                                                                // :
        // event_interceptIncludeRegexTextFieldActionPerformed
        _manualEdit.setIncludeRegex(interceptIncludeRegexTextField.getText());
     ...
     * 
     * @see
     * edu.lnmiit.wavd.plugin.proxy.ManualEditUI#editRequest(edu.lnmiit.wavd
     * .model.Request)
     */
     ...
     * 
     * @see
     * edu.lnmiit.wavd.plugin.proxy.ManualEditUI#editResponse(edu.lnmiit.wavd
     * .model.Request, edu.lnmiit.wavd.model.Response)
     */
