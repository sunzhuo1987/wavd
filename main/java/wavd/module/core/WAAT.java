...
public class WAAT {
    ...
    public static void main(String[] args) {
        ...
        final SplashScreen splash = new SplashScreen("/wavd/module/core/waat.gif");
        splash.open(10000);
        initLogging();
            ...
            try {
                SwingUtilities.invokeAndWait(new Runnable() {
                    public void run() {
                        ...
                        uif.toFront();
                        uif.requestFocus();
                        uif.setTitle("Web Aplication Audit Tool - BTP Project - Udai Gupta and Hemant Purohit");
                        splash.close();
                    }
                });
            } catch (Exception e) {
